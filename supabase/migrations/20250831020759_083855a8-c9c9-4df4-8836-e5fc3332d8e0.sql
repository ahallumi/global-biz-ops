...
BEGIN
  ...
  SELECT id, old_status, new_status, error_msg FROM stale_running;
  ...
  SELECT id, old_status, new_status, error_msg FROM stale_pending;
  ...
  SELECT id, old_status, new_status, error_msg FROM stale_partial;
END;
$function$;
