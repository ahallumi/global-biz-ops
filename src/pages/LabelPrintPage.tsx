...
import { PDFPreviewDialog } from '@/components/printing/PDFPreviewDialog';
import { Printer, Search, Zap, Package, Tag, Barcode, ArrowLeft, Eye } from 'lucide-react';
...
export default function LabelPrintPage() {
  ...
  // Get active profile for PDF preview
  const activeProfile = config?.profiles?.find(p => p.id === config.active_profile_id) || null;
  ...
  // Handle PDF preview for product
              ...
              <div className="flex items-start gap-3 text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• Use Preview PDF to verify exact output before printing</li>
